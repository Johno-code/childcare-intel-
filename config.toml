...
| ABS Census 2021 (demographics) | `connectors/datasources.py:census_demographics` | drop DataPack to `data/abs_<suburb>.csv` | High when loaded |
...
2. **ABS Data API** wiring (live SA2/SAL pulls) to replace DEMO demographics.
